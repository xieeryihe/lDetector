...
正例一 q="*时新疆·车师（*宁音乐广场店）"，q_type='新疆菜' ，keyword='*宁 新疆菜'，judgement='yes'
正例二 q="*泉小町·日式SPA（*陇店）"，q_type='按摩/足疗'， keyword='做SPA'，judgement='yes'
正例三 q="*茄田艺术（*山高境中心）"，q_type='美术'， keyword='画画 附近'，judgement='yes'
以下是几个不合理的keyword,可供参考。
反例一 q="*月半美甲美睫"，q_type='美甲' ，keyword='睫 *月半美甲美'，judgement='no'
这个keyword不合理的原因是“睫”不是可以售卖的商品或服务，因为断句错误而不符合普通用户表达习惯
反例二 q="*斐儿（*图苑店）"，q_type='美甲'， keyword='美甲公众号'，judgement='no'
这个keyword不合理的原因是“美甲公众号”不是可以售卖的商品或服务，不符合普通用户表达习惯，并且不能对店铺q"*斐儿（*图苑店）"完成搜索
反例三 q="*尚造型（*清路店）"，q_type='美发'， keyword='*尚附近剪头发'，judgement='no'
这个例子错误的原因是“*尚”是店名，不是地名，因此“*尚附近”不符合普通用户表达习惯，不是合理的搜索关键词。
反例四 q="*底捞（*角场*生汇店）"，q_type='火锅'， keyword='*生汇'，judgement='no'
这个例子错误的原因是“*生汇”是一个商场，范围远大于店铺q"*底捞（*角场*生汇店）"，不能完成对"*底捞（*角场*生汇店）"的搜索，因此不是合理的搜索关键词
'''
